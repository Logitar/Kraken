...
public sealed class RealmEntity : AggregateEntity
{
  ...
  public void Update(RealmUpdated @event)
  {
    ...
    {
      string key = customAttribute.Key.Value;
      ...
      {
        customAttributes[key] = customAttribute.Value;
      }
    }
  ...
  private void SetCustomAttributes(IDictionary<string, string> customAttributes)
  {
