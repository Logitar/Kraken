...
public interface IRoleRepository
{
  ...
  Task<IReadOnlyCollection<Role>> LoadAsync(ApiKeyId apiKeyId, CancellationToken cancellationToken = default);
  Task<IReadOnlyCollection<Role>> LoadAsync(RealmId? realmId, CancellationToken cancellationToken = default);
  Task<IReadOnlyCollection<Role>> LoadAsync(UserId userId, CancellationToken cancellationToken = default);
