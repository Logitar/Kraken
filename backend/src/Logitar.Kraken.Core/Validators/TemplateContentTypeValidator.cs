...
internal class TemplateContentTypeValidator<T> : IPropertyValidator<T, string>
{
  private readonly HashSet<string> _contentTypes = [MediaTypeNames.Text.Plain, MediaTypeNames.Text.Html];
