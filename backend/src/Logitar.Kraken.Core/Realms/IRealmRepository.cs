...
public interface IRealmRepository
{
  ...
  Task<Realm?> LoadAsync(RealmId id, bool? isDeleted, long? version, CancellationToken cancellationToken = default);
  ...
  Task<IReadOnlyCollection<Realm>> LoadAsync(bool? isDeleted, IEnumerable<RealmId> ids, CancellationToken cancellationToken = default);
