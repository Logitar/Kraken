...
public class InitializeConfigurationCommandHandlerTests
{
  ...
  {
    _handler = new(_cacheService.Object, _configurationQuerier.Object, _configurationRepository.Object, _languageManager.Object, _passwordManager.Object, _userManager.Object);
  }
  ...
  public async Task Given_NotInitialized_When_Handle_Then_Initialized()
  {
    ...
    _passwordManager.Setup(x => x.ValidateAndCreate(It.IsAny<IPasswordSettings>(), command.Password)).Returns(password);
