...
public class DeleteUserCommandHandlerTests
{
  ...
  public DeleteUserCommandHandlerTests()
  {
    ...
    _user = new(new UniqueName(new UniqueNameSettings(), _faker.Person.UserName), actorId: null, UserId.NewId(_realmId));
  ...
  public async Task Given_Found_When_Handle_Then_Deleted()
  {
    ...
    OneTimePassword[] oneTimePasswords = [new(password, userId: _user.Id, oneTimePasswordId: OneTimePasswordId.NewId(_realmId))];
